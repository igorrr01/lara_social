              ...
              <div class="card-footer">
                <form action="/post/comment/{{ $post->id }}" method="post">
                  ...
                  <div class="img-push">
                    ...
                    <input type="text" class="form-control form-control-sm" name="comment" placeholder="Нажмите enter для отправки комментария" data-emojiable="true" data-emoji-input="unicode"></p>
